...
@interface PopMsgUnitViewController ()
{
    NSMutableArray *_tableDataSource;
}
@end

@implementation PopMsgUnitViewController
...
-(void)loadTableView{
    ...
    _tableDataSource=[[NSMutableArray alloc]initWithObjects:@"斤",@"箱",@"包",nil];
