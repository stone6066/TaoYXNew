...
@interface GoodsInfoViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
static NSString * const GoodsInfoCellId = @"goodsinfoTableCell";
-(void)loadTableView{
    ...
    [self.TableView registerClass:[GoodsInfoTableViewCell class] forCellReuseIdentifier:GoodsInfoCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    GoodsInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:GoodsInfoCellId forIndexPath:indexPath];
...
-(void)popDetailView:(CarExpressDeal*)InfoData{
    GoodsDetailInfoViewController *componyView=[[GoodsDetailInfoViewController alloc]init];
