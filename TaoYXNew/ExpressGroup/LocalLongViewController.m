...
#import "LocalLongTableViewCell.h"
#import "LongExpressDeal.h"

@interface LocalLongViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
@implementation LocalLongViewController
...
static NSString * const LongCellId = @"longCellId";
-(void)loadTableView{
    ...
    [self.TableView registerClass:[LocalLongTableViewCell class] forCellReuseIdentifier:LongCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LocalLongTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:LongCellId forIndexPath:indexPath];
    
    // 将数据视图框架模型(该模型中包含了数据模型)赋值给Cell，
    LongExpressDeal *dm=_tableDataSource[indexPath.item];
...
//    LocalLongTableViewCell *svc =(LocalLongTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
