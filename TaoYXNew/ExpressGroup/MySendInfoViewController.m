...
@interface MySendInfoViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
@implementation MySendInfoViewController
...
static NSString * const MyInfoCellId = @"myinfoTableCell";
-(void)loadTableView{
    ...
    [self.TableView registerClass:[MySendInfoTableViewCell class] forCellReuseIdentifier:MyInfoCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MySendInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:MyInfoCellId forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    MySendInfoTableViewCell *svc =(MySendInfoTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
