...
@interface LocalStationViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
@implementation LocalStationViewController
...
static NSString * const StationCellId = @"StationCellId";
-(void)loadTableView{
    ...
    [self.TableView registerClass:[LocalStationTableViewCell class] forCellReuseIdentifier:StationCellId];
...
-(void)request:(DPRequest *)request didFinishLoadingWithResult:(id)result
{
    ...
    dm= [[LocalStationDeal alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LocalStationTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:StationCellId forIndexPath:indexPath];
    
    // 将数据视图框架模型(该模型中包含了数据模型)赋值给Cell，
    LocalStationDeal *dm=_tableDataSource[indexPath.item];
...
//    LocalStationTableViewCell *svc =(LocalStationTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
