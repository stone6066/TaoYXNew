...
#import "DPAPI.h"
@interface DetailTraceViewController ()<UIWebViewDelegate,DPRequestDelegate>

@end

@implementation DetailTraceViewController
...
-(void)setTraceData:(TraceInfoDeal *)traceData{
...
-(void)loadMsgInfo:(TraceInfoDeal*)SM{
...
-(void)loadWebView{
    if(![_empDesc isEqual:[NSNull null]])
    {
...
- (void)createRequest{
    ...
    [params setValue:_traceData.priceInfoId forKey:@"id"];
