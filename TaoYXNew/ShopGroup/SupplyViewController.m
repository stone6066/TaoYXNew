...
@interface SupplyViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
static NSString * const SupplyTableCellId = @"SupplyTableCell";
-(void)loadTableView{
    ...
    [self.TableView registerClass:[SupplyTableViewCell class] forCellReuseIdentifier:SupplyTableCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SupplyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:SupplyTableCellId forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
        ...
        SupplyModel *dm= [svc praseModelWithCell:svc];
        //NSLog(@"%ld---%@---cellUrl:",indexPath.item,dm.supplyDesc);
        
        DetailSupplyViewController *shortCutView=[[DetailSupplyViewController alloc]init];
        shortCutView.hidesBottomBarWhenPushed=YES;
        shortCutView.navigationItem.hidesBackButton=YES;
        
        [shortCutView setSupplyData:dm];
