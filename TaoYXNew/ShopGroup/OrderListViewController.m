...
@interface OrderListViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
-(void)loadTableView{
    ...
    [self.TableView registerClass:[OrderListTableViewCell class] forCellReuseIdentifier:OrderListCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OrderListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:OrderListCellId forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    OrderListTableViewCell *svc =(OrderListTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
