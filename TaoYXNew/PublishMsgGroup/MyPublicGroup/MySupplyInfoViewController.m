...
@interface MySupplyInfoViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
@implementation MySupplyInfoViewController
...
- (void)createRequest{
    ...
    [params setValue:@"supplylistex" forKey:@"ut"];
...
-(void)loadTableView{
    ...
    [self.TableView registerClass:[SupplyTableViewCell class] forCellReuseIdentifier:@"myCellID"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SupplyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"myCellID" forIndexPath:indexPath];
    
    // 将数据视图框架模型(该模型中包含了数据模型)赋值给Cell，
    SupplyModel *dm=_tableDataSource[indexPath.item];
...
-(void)popCommonView:(NSString*)idStr{
    DetailPubSupplyViewController *componyView=[[DetailPubSupplyViewController alloc]init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    SupplyTableViewCell *svc =(SupplyTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
    [self popCommonView:svc.supplyId];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SupplyTableViewCell *svc =(SupplyTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
    [self createDelCarRequest:svc.supplyId];
}
...
- (void)createDelCarRequest:(NSString*)delId{
    DPAPI *api = [[DPAPI alloc]init];
    NSMutableDictionary *params = [[NSMutableDictionary alloc]init];
    [params setValue:@"delsupply" forKey:@"ut"];
