...
@interface MyPubPriceViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
@implementation MyPubPriceViewController
...
- (void)createRequest{
    ...
    [params setValue:@"pricelist" forKey:@"ut"];
...
-(void)loadTableView{
    ...
    [self.TableView registerClass:[PlaceTypeTableViewCell class] forCellReuseIdentifier:@"myCellID"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PlaceTypeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"myCellID" forIndexPath:indexPath];
...
-(void)popCommonView:(NSString*)idStr{
    DetailPubPriceViewController *componyView=[[DetailPubPriceViewController alloc]init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self popCommonView:svc.priceId];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PlaceTypeTableViewCell *svc =(PlaceTypeTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
    [self createDelCarRequest:svc.priceId];
}
...
- (void)createDelCarRequest:(NSString*)delId{
    DPAPI *api = [[DPAPI alloc]init];
    NSMutableDictionary *params = [[NSMutableDictionary alloc]init];
    [params setValue:@"delprice" forKey:@"ut"];
