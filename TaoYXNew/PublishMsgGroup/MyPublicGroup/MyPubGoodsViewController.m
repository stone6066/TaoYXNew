...
@interface MyPubGoodsViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
...
@implementation MyPubGoodsViewController
...
- (void)createRequest{
    ...
    [params setValue:@"loginfolist" forKey:@"ut"];
    [params setValue:@"0" forKey:@"logInfoType"];//1车源pubId
...
-(void)loadTableView{
    ...
    [self.TableView registerClass:[GoodsInfoTableViewCell class] forCellReuseIdentifier:@"myCellID"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    GoodsInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"myCellID" forIndexPath:indexPath];
...
-(void)popCommonView:(NSString*)idStr{
    DetailPubExpViewController *componyView=[[DetailPubExpViewController alloc]init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    GoodsInfoTableViewCell *svc =(GoodsInfoTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
    [self popCommonView:svc.expId];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GoodsInfoTableViewCell *svc =(GoodsInfoTableViewCell*)[self.TableView cellForRowAtIndexPath:indexPath];
    [self createDelCarRequest:svc.expId];
}
...
- (void)createDelCarRequest:(NSString*)delId{
    DPAPI *api = [[DPAPI alloc]init];
    NSMutableDictionary *params = [[NSMutableDictionary alloc]init];
    [params setValue:@"delloginfo" forKey:@"ut"];
