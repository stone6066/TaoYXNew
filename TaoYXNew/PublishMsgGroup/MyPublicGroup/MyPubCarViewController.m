...
@interface MyPubCarViewController ()<DPRequestDelegate,MJRefreshBaseViewDelegate>
{
    ...
    NSInteger selectedTableIndex;//选中的cell行
}

@end

@implementation MyPubCarViewController
...
- (void)createRequest{
    ...
    [params setValue:@"1" forKey:@"logInfoType"];//1车源pubId
...
-(void)loadTableView{
    ...
    [self.TableView registerClass:[CarInfoTableViewCell class] forCellReuseIdentifier:@"myCellID"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CarInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"myCellID" forIndexPath:indexPath];
